...
${OBJECTDIR}/src/shadowdetection/learning/TrainingSet.o: src/shadowdetection/learning/TrainingSet.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_AMD -D_OPENCL -I/usr/local/include/opencv -I/opt/AMDAPP/include -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/shadowdetection/learning/TrainingSet.o src/shadowdetection/learning/TrainingSet.cpp
