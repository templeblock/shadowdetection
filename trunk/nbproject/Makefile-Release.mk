...
${OBJECTDIR}/src/cpp/core/opencl/libsvm/OpenCLToolsPredict.o: src/cpp/core/opencl/libsvm/OpenCLToolsPredict.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/local/include/opencv -Isrc/cpp -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cpp/core/opencl/libsvm/OpenCLToolsPredict.o src/cpp/core/opencl/libsvm/OpenCLToolsPredict.cpp

${OBJECTDIR}/src/cpp/core/opencl/libsvm/OpenCLToolsTrain.o: src/cpp/core/opencl/libsvm/OpenCLToolsTrain.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cpp/core/opencl/libsvm
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/local/include/opencv -Isrc/cpp -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cpp/core/opencl/libsvm/OpenCLToolsTrain.o src/cpp/core/opencl/libsvm/OpenCLToolsTrain.cpp
...
${OBJECTDIR}/src/cpp/core/opencl/regression/OpenCLRegressionPredict.o: src/cpp/core/opencl/regression/OpenCLRegressionPredict.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/local/include/opencv -Isrc/cpp -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cpp/core/opencl/regression/OpenCLRegressionPredict.o src/cpp/core/opencl/regression/OpenCLRegressionPredict.cpp
...
${OBJECTDIR}/src/cpp/core/process/MakeSetProcessor.o: src/cpp/core/process/MakeSetProcessor.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/local/include/opencv -Isrc/cpp -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cpp/core/process/MakeSetProcessor.o src/cpp/core/process/MakeSetProcessor.cpp

${OBJECTDIR}/src/cpp/core/process/TrainingProcessor.o: src/cpp/core/process/TrainingProcessor.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cpp/core/process
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/local/include/opencv -Isrc/cpp -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cpp/core/process/TrainingProcessor.o src/cpp/core/process/TrainingProcessor.cpp
...
${OBJECTDIR}/src/cpp/core/util/rtti/ObjectFactory.o: src/cpp/core/util/rtti/ObjectFactory.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/local/include/opencv -Isrc/cpp -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cpp/core/util/rtti/ObjectFactory.o src/cpp/core/util/rtti/ObjectFactory.cpp

${OBJECTDIR}/src/cpp/core/util/rtti/RTTIStorage.o: src/cpp/core/util/rtti/RTTIStorage.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cpp/core/util/rtti
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/local/include/opencv -Isrc/cpp -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cpp/core/util/rtti/RTTIStorage.o src/cpp/core/util/rtti/RTTIStorage.cpp
...
${OBJECTDIR}/src/cpp/shadowdetection/opencl/OpenCLImageParameters.o: src/cpp/shadowdetection/opencl/OpenCLImageParameters.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/local/include/opencv -Isrc/cpp -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cpp/shadowdetection/opencl/OpenCLImageParameters.o src/cpp/shadowdetection/opencl/OpenCLImageParameters.cpp
...
${OBJECTDIR}/src/cpp/shadowdetection/process/ShadowDetectionProcessor.o: src/cpp/shadowdetection/process/ShadowDetectionProcessor.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/local/include/opencv -Isrc/cpp -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cpp/shadowdetection/process/ShadowDetectionProcessor.o src/cpp/shadowdetection/process/ShadowDetectionProcessor.cpp
...
${OBJECTDIR}/src/cpp/skydetection/SkyDetection.o: src/cpp/skydetection/SkyDetection.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/local/include/opencv -Isrc/cpp -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cpp/skydetection/SkyDetection.o src/cpp/skydetection/SkyDetection.cpp
