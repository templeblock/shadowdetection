...
${OBJECTDIR}/src/cpp/shadowdetection/util/PredictorFactory.o: src/cpp/shadowdetection/util/PredictorFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cpp/shadowdetection/util
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/local/include/opencv -Isrc/cpp -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cpp/shadowdetection/util/PredictorFactory.o src/cpp/shadowdetection/util/PredictorFactory.cpp
