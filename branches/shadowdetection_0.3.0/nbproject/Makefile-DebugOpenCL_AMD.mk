...
${OBJECTDIR}/src/cpp/core/util/image/ImageParameters.o: src/cpp/core/util/image/ImageParameters.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -D_AMD -D_DEBUG -D_OPENCL -I/usr/local/include/opencv -I/opt/AMDAPP/include -Isrc/cpp -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cpp/core/util/image/ImageParameters.o src/cpp/core/util/image/ImageParameters.cpp
