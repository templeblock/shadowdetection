...
${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D_MAC -I/usr/local/include/opencv -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
...
${OBJECTDIR}/src/shadowdetection/opencl/OpenCLTools.o: src/shadowdetection/opencl/OpenCLTools.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D_MAC -I/usr/local/include/opencv -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/shadowdetection/opencl/OpenCLTools.o src/shadowdetection/opencl/OpenCLTools.cpp

${OBJECTDIR}/src/shadowdetection/opencl/OpenCLToolsLibSVM.o: src/shadowdetection/opencl/OpenCLToolsLibSVM.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/shadowdetection/opencl
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D_MAC -I/usr/local/include/opencv -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/shadowdetection/opencl/OpenCLToolsLibSVM.o src/shadowdetection/opencl/OpenCLToolsLibSVM.cpp
...
${OBJECTDIR}/src/shadowdetection/opencv/OpenCV2Tools.o: src/shadowdetection/opencv/OpenCV2Tools.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D_MAC -I/usr/local/include/opencv -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/shadowdetection/opencv/OpenCV2Tools.o src/shadowdetection/opencv/OpenCV2Tools.cpp

${OBJECTDIR}/src/shadowdetection/opencv/OpenCVTools.o: src/shadowdetection/opencv/OpenCVTools.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/shadowdetection/opencv
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D_MAC -I/usr/local/include/opencv -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/shadowdetection/opencv/OpenCVTools.o src/shadowdetection/opencv/OpenCVTools.cpp
...
${OBJECTDIR}/src/shadowdetection/tools/svm/TrainingSet.o: src/shadowdetection/tools/svm/TrainingSet.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D_MAC -I/usr/local/include/opencv -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/shadowdetection/tools/svm/TrainingSet.o src/shadowdetection/tools/svm/TrainingSet.cpp
...
${OBJECTDIR}/src/shadowdetection/tools/svm/libsvmopenmp/svm-train.o: src/shadowdetection/tools/svm/libsvmopenmp/svm-train.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D_MAC -I/usr/local/include/opencv -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/shadowdetection/tools/svm/libsvmopenmp/svm-train.o src/shadowdetection/tools/svm/libsvmopenmp/svm-train.cpp

${OBJECTDIR}/src/shadowdetection/util/Cofig.o: src/shadowdetection/util/Cofig.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/shadowdetection/util
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D_MAC -I/usr/local/include/opencv -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/shadowdetection/util/Cofig.o src/shadowdetection/util/Cofig.cpp

${OBJECTDIR}/src/shadowdetection/util/TabParser.o: src/shadowdetection/util/TabParser.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/shadowdetection/util
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D_MAC -I/usr/local/include/opencv -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/shadowdetection/util/TabParser.o src/shadowdetection/util/TabParser.cpp

${OBJECTDIR}/src/shadowdetection/util/Timer.o: src/shadowdetection/util/Timer.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/shadowdetection/util
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D_MAC -I/usr/local/include/opencv -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/shadowdetection/util/Timer.o src/shadowdetection/util/Timer.cpp
...
${OBJECTDIR}/src/shadowdetection/util/image/ImageParameters.o: src/shadowdetection/util/image/ImageParameters.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D_MAC -I/usr/local/include/opencv -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/shadowdetection/util/image/ImageParameters.o src/shadowdetection/util/image/ImageParameters.cpp

${OBJECTDIR}/src/thirdparty/lib_svm/svm.o: src/thirdparty/lib_svm/svm.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/thirdparty/lib_svm
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -D_MAC -I/usr/local/include/opencv -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/thirdparty/lib_svm/svm.o src/thirdparty/lib_svm/svm.cpp
