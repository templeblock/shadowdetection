...
${OBJECTDIR}/_ext/33800812/OpenCV2Tools.o: /data/Dev/shadowdetection/src/shadowdetection/opencv/OpenCV2Tools.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_OPENCL -I/usr/local/include/opencv -Isrc -Xcompiler "-MMD -MP -MF $@.d" -o ${OBJECTDIR}/_ext/33800812/OpenCV2Tools.o /data/Dev/shadowdetection/src/shadowdetection/opencv/OpenCV2Tools.cpp
