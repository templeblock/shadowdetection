...
${OBJECTDIR}/src/cpp/shadowdetection/util/PredictorManager.o: src/cpp/shadowdetection/util/PredictorManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cpp/shadowdetection/util
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/local/include/opencv -Isrc/cpp -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cpp/shadowdetection/util/PredictorManager.o src/cpp/shadowdetection/util/PredictorManager.cpp
...
${OBJECTDIR}/src/cpp/shadowdetection/util/predicition/libsvm/SvmPredict.o: src/cpp/shadowdetection/util/predicition/libsvm/SvmPredict.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/local/include/opencv -Isrc/cpp -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cpp/shadowdetection/util/predicition/libsvm/SvmPredict.o src/cpp/shadowdetection/util/predicition/libsvm/SvmPredict.cpp
...
${OBJECTDIR}/src/cpp/shadowdetection/util/predicition/regression/RegressionPredict.o: src/cpp/shadowdetection/util/predicition/regression/RegressionPredict.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/local/include/opencv -Isrc/cpp -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cpp/shadowdetection/util/predicition/regression/RegressionPredict.o src/cpp/shadowdetection/util/predicition/regression/RegressionPredict.cpp
