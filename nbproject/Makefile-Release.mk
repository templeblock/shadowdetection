...
${OBJECTDIR}/src/shadowdetection/learning/TrainingSet.o: src/shadowdetection/learning/TrainingSet.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/local/include/opencv -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/shadowdetection/learning/TrainingSet.o src/shadowdetection/learning/TrainingSet.cpp
