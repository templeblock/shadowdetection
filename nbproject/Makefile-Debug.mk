...
${OBJECTDIR}/src/cpp/core/util/MemMenager.o: src/cpp/core/util/MemMenager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cpp/core/util
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include/opencv -Isrc/cpp -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cpp/core/util/MemMenager.o src/cpp/core/util/MemMenager.cpp
...
${OBJECTDIR}/src/cpp/core/util/image/ImageParameters.o: src/cpp/core/util/image/ImageParameters.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include/opencv -Isrc/cpp -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cpp/core/util/image/ImageParameters.o src/cpp/core/util/image/ImageParameters.cpp
