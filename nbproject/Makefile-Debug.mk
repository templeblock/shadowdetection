...
${OBJECTDIR}/src/cpp/shadowdetection/util/PredictorManager.o: src/cpp/shadowdetection/util/PredictorManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cpp/shadowdetection/util
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include/opencv -Isrc/cpp -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cpp/shadowdetection/util/PredictorManager.o src/cpp/shadowdetection/util/PredictorManager.cpp
